...
function AlbumsController($scope, $modal, Albums, Album, Status, SendList, GetList) {
    function list() {
...
function QueueModalController($scope, $modalInstance, albumList, action) {
    $scope.queueAction = action;
    $scope.albumList = albumList;

    $scope.ok = function () {
        $modalInstance.close($scope.albumList);
    };
